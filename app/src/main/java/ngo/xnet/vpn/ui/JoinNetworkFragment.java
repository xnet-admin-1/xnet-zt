...
import ngo.xnet.vpn.model.DnsServer;
import ngo.xnet.vpn.model.DnsServerDao;
import ngo.xnet.vpn.model.Network;
import ngo.xnet.vpn.model.NetworkConfig;
import ngo.xnet.vpn.model.NetworkDao;
import ngo.xnet.vpn.util.NetworkIdUtils;
        ...
        this.mJoinButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    DaoSession daoSession = ((XnetApplication) JoinNetworkFragment.this.getActivity().getApplication()).getDaoSession();
