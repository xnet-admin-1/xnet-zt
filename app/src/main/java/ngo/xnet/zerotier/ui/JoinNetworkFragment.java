...
import ngo.xnet.zerotier.model.DnsServer;
import ngo.xnet.zerotier.model.DnsServerDao;
...
import ngo.xnet.zerotier.util.NetworkIdUtils;
        ...
        this.mJoinButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    DaoSession daoSession = ((XNetZTApplication) JoinNetworkFragment.this.getActivity().getApplication()).getDaoSession();
